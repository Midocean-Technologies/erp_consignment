...
frappe.ui.form.on('Consignment Order', {
	refresh(frm) {
		...
		frm.add_custom_button('Create Delivery', function(frm)

		{

			frappe.model.open_mapped_doc({
				method: "erp_consignment.erp_consignment.doctype.consignment_order.consignment_order.make_delivery_note",
				frm: cur_frm,
				args: {
...
frappe.ui.form.on("Consignment Order Item", {
